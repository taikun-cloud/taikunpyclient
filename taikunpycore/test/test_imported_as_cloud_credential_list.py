...
class TestImportedAsCloudCredentialList(unittest.TestCase):
    """ImportedAsCloudCredentialList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportedAsCloudCredentialList:
        """Test ImportedAsCloudCredentialList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportedAsCloudCredentialList`
        """
        model = ImportedAsCloudCredentialList()
        if include_optional:
            return ImportedAsCloudCredentialList(
                visibility = taikunpycore.models.imported_as_cloud_credential_visibility.ImportedAsCloudCredentialVisibility(
    ...
    def testImportedAsCloudCredentialList(self):
        """Test ImportedAsCloudCredentialList"""

...
class TestAlertingProfilesListDto(unittest.TestCase):
    """AlertingProfilesListDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertingProfilesListDto:
        """Test AlertingProfilesListDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertingProfilesListDto`
        """
        model = AlertingProfilesListDto()
        if include_optional:
            return AlertingProfilesListDto(
                id = 56,
                name = '',
                organization_id = 56,
                organization_name = '',
    ...
    def testAlertingProfilesListDto(self):
        """Test AlertingProfilesListDto"""

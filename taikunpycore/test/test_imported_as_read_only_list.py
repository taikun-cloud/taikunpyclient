...
class TestImportedAsReadOnlyList(unittest.TestCase):
    """ImportedAsReadOnlyList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportedAsReadOnlyList:
        """Test ImportedAsReadOnlyList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportedAsReadOnlyList`
        """
        model = ImportedAsReadOnlyList()
        if include_optional:
            return ImportedAsReadOnlyList(
                visibility = taikunpycore.models.imported_as_read_only_visibility.ImportedAsReadOnlyVisibility(
    ...
    def testImportedAsReadOnlyList(self):
        """Test ImportedAsReadOnlyList"""

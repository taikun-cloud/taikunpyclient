...
class TestProjectListDetailDto(unittest.TestCase):
    """ProjectListDetailDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectListDetailDto:
        """Test ProjectListDetailDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectListDetailDto`
        """
        model = ProjectListDetailDto()
        if include_optional:
            return ProjectListDetailDto(
                id = 56,
                name = '',
                is_kubernetes = True,
                is_locked = True,
    ...
    def testProjectListDetailDto(self):
        """Test ProjectListDetailDto"""

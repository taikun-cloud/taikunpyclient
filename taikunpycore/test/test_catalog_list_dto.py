...
class TestCatalogListDto(unittest.TestCase):
    """CatalogListDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CatalogListDto:
        """Test CatalogListDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CatalogListDto`
        """
        model = CatalogListDto()
        if include_optional:

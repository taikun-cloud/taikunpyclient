...
class TestAccessProfilesList(unittest.TestCase):
    """AccessProfilesList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessProfilesList:
        """Test AccessProfilesList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessProfilesList`
        """
        model = AccessProfilesList()
        if include_optional:
            return AccessProfilesList(
                data = [
                    taikunpycore.models.access_profiles_list_dto.AccessProfilesListDto(
                        id = 56, 
                        name = '', 
                        http_proxy = '', 
                        organization_id = 56, 
    ...
    def testAccessProfilesList(self):
        """Test AccessProfilesList"""

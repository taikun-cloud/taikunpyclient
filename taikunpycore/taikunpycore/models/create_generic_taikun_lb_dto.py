...
class CreateGenericTaikunLbDto(BaseModel):
    """
    CreateGenericTaikunLbDto
    """ # noqa: E501
    svc_name: Optional[StrictStr] = Field(default=None, alias="svcName")
    svc_namespace: Optional[StrictStr] = Field(default=None, alias="svcNamespace")
    __properties: ClassVar[List[str]] = ["svcName", "svcNamespace"]

...
class CreateSecurityGroupCommand(BaseModel):
    """
    CreateSecurityGroupCommand
    """ # noqa: E501
    name: Optional[StrictStr] = None
    protocol: Optional[SecurityGroupProtocol] = None
    port_min_range: Optional[StrictInt] = Field(default=None, alias="portMinRange")
    port_max_range: Optional[StrictInt] = Field(default=None, alias="portMaxRange")
    remote_ip_prefix: Optional[StrictStr] = Field(default=None, alias="remoteIpPrefix")
    stand_alone_profile_id: Optional[StrictInt] = Field(default=None, alias="standAloneProfileId")
    __properties: ClassVar[List[str]] = ["name", "protocol", "portMinRange", "portMaxRange", "remoteIpPrefix", "standAloneProfileId"]

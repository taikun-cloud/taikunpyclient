...
class DeploymentCompletedCommand(BaseModel):
    """
    DeploymentCompletedCommand
    """ # noqa: E501
    project_id: Optional[StrictInt] = Field(default=None, alias="projectId")
    result: Optional[StrictStr] = None
    from_cron_job: Optional[StrictBool] = Field(default=None, alias="fromCronJob")
    __properties: ClassVar[List[str]] = ["projectId", "result", "fromCronJob"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fromCronJob": obj.get("fromCronJob")
        })
        return _obj

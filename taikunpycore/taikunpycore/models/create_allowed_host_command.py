...
class CreateAllowedHostCommand(BaseModel):
    """
    ...
    mask_bits: Optional[StrictInt] = Field(default=None, alias="maskBits")
    __properties: ClassVar[List[str]] = ["accessProfileId", "description", "ipAddress", "maskBits"]

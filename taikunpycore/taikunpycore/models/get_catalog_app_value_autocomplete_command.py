...
class GetCatalogAppValueAutocompleteCommand(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["packageId", "version", "catalogAppId", "isQuestion"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if is_question (nullable) is None
        # and model_fields_set contains the field
        if self.is_question is None and "is_question" in self.model_fields_set:
            _dict['isQuestion'] = None

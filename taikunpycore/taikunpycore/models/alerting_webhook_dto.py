...
class AlertingWebhookDto(BaseModel):
    """
    AlertingWebhookDto
    """ # noqa: E501
    id: Optional[StrictInt] = None
    url: Optional[StrictStr] = None
    headers: Optional[List[WebhookHeaderDto]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "url": obj.get("url"),
            "headers": [WebhookHeaderDto.from_dict(_item) for _item in obj["headers"]] if obj.get("headers") is not None else None
        })
        return _obj

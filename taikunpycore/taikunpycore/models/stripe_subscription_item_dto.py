...
class StripeSubscriptionItemDto(BaseModel):
    """
    StripeSubscriptionItemDto
    """ # noqa: E501
    subscription_item_id: Optional[StrictStr] = Field(alias="subscriptionItemId")
    price_id: Optional[StrictStr] = Field(alias="priceId")
    product_id: Optional[StrictStr] = Field(alias="productId")
    __properties: ClassVar[List[str]] = ["subscriptionItemId", "priceId", "productId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscriptionItemId": obj.get("subscriptionItemId"),

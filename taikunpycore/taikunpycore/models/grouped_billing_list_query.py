...
class GroupedBillingListQuery(BaseModel):
    """
    GroupedBillingListQuery
    """ # noqa: E501
    organization_id: Optional[StrictInt] = Field(default=None, alias="organizationId")
    period_duration: Optional[BillingPeriod] = Field(default=None, alias="periodDuration")
    is_deleted: Optional[StrictBool] = Field(default=None, alias="isDeleted")
    __properties: ClassVar[List[str]] = ["organizationId", "periodDuration", "isDeleted"]

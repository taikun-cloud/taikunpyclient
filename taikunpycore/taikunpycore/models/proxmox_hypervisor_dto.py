...
class ProxmoxHypervisorDto(BaseModel):
    """
    ProxmoxHypervisorDto
    """ # noqa: E501
    name: Optional[StrictStr] = None
    is_bound: Optional[StrictBool] = Field(default=None, alias="isBound")
    used_by_server: Optional[StrictBool] = Field(default=None, alias="usedByServer")
    __properties: ClassVar[List[str]] = ["name", "isBound", "usedByServer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usedByServer": obj.get("usedByServer")
        })
        return _obj

...
class AdminProjectUpdateCommand(BaseModel):
    """
    AdminProjectUpdateCommand
    """ # noqa: E501
    id: Optional[StrictInt] = None
    kubernetes_current_version: Optional[StrictStr] = Field(default=None, alias="kubernetesCurrentVersion")
    kubespray_current_version: Optional[StrictStr] = Field(default=None, alias="kubesprayCurrentVersion")
    __properties: ClassVar[List[str]] = ["id", "kubernetesCurrentVersion", "kubesprayCurrentVersion"]

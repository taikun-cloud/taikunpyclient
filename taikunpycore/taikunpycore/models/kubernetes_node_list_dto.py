...
class KubernetesNodeListDto(BaseModel):
    """
    KubernetesNodeListDto
    """ # noqa: E501
    metadata_name: Optional[StrictStr] = Field(alias="metadataName")
    type: Optional[List[StrictStr]]
    status: Optional[List[StrictStr]]
    reason: Optional[List[StrictStr]]
    message: Optional[List[StrictStr]]
    __properties: ClassVar[List[str]] = ["metadataName", "type", "status", "reason", "message"]

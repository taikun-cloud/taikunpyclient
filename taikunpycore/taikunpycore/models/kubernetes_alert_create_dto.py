...
class KubernetesAlertCreateDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "labels", "annotations", "startsAt", "endsAt", "fingerprint"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "annotations": KubernetesAnnotations.from_dict(obj["annotations"]) if obj.get("annotations") is not None else None,

...
class VsphereNetworkListDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "gateway", "ipAddress", "netMask", "beginAllocationRange", "endAllocationRange", "isPrivate", "isVirtualLbNetwork"]

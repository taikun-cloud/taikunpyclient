...
class UserTokensListDto(BaseModel):
    """
    UserTokensListDto
    """ # noqa: E501
    ...
    expire_date: Optional[StrictStr] = Field(alias="expireDate")
    access_key: Optional[StrictStr] = Field(alias="accessKey")
    __properties: ClassVar[List[str]] = ["id", "name", "createdAt", "isReadonly", "expireDate", "accessKey"]

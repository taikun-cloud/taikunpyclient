...
class CreateKubernetesResourceCommand(BaseModel):
    """
    CreateKubernetesResourceCommand
    """ # noqa: E501
    project_id: Optional[StrictInt] = Field(alias="projectId")
    yaml: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["projectId", "yaml"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.yaml is None and "yaml" in self.model_fields_set:
            _dict['yaml'] = None

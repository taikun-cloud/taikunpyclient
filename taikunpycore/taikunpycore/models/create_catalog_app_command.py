...
class CreateCatalogAppCommand(BaseModel):
    """
    ...
    parameters: Optional[List[CatalogAppParamsDto]] = None
    __properties: ClassVar[List[str]] = ["repoName", "packageName", "catalogId", "version", "parameters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parameters": [CatalogAppParamsDto.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None
        })
        return _obj

...
class UserResourceChartDto(BaseModel):
    """
    ...
    max_ram: Optional[StrictInt] = Field(default=None, alias="maxRam")
    max_cpu: Optional[StrictInt] = Field(default=None, alias="maxCpu")
    max_disk_size: Optional[StrictInt] = Field(default=None, alias="maxDiskSize")
    __properties: ClassVar[List[str]] = ["projectName", "projectId", "diskSize", "ram", "cpu", "maxRam", "maxCpu", "maxDiskSize"]

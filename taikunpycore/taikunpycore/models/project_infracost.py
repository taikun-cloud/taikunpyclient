...
class ProjectInfracost(BaseModel):
    """
    ProjectInfracost
    """ # noqa: E501
    ...
    past_breakdown: Optional[Breakdown] = Field(default=None, alias="pastBreakdown")
    breakdown: Optional[Breakdown] = None
    diff: Optional[Diff] = None
    summary: Optional[Summary] = None
    __properties: ClassVar[List[str]] = ["name", "displayName", "metadata", "pastBreakdown", "breakdown", "diff", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": ProjectMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "pastBreakdown": Breakdown.from_dict(obj["pastBreakdown"]) if obj.get("pastBreakdown") is not None else None,
            "breakdown": Breakdown.from_dict(obj["breakdown"]) if obj.get("breakdown") is not None else None,
            "diff": Diff.from_dict(obj["diff"]) if obj.get("diff") is not None else None,

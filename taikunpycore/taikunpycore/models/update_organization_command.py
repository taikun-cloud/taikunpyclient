...
class UpdateOrganizationCommand(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "fullName", "phone", "email", "address", "country", "city", "vatNumber", "isLocked", "billingEmail", "discountRate", "isEligibleUpdateSubscription"]

...
class CheckOpenstackCommand(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["openStackUser", "openStackPassword", "openStackUrl", "openStackDomain", "isAdmin", "applicationCredEnabled"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if application_cred_enabled (nullable) is None
        # and model_fields_set contains the field
        if self.application_cred_enabled is None and "application_cred_enabled" in self.model_fields_set:
            _dict['applicationCredEnabled'] = None

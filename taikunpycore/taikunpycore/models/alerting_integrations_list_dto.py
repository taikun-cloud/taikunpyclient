...
class AlertingIntegrationsListDto(BaseModel):
    """
    ...
    alerting_integration_type: AlertingIntegrationType = Field(alias="alertingIntegrationType")
    alerting_profile_name: Optional[StrictStr] = Field(alias="alertingProfileName")
    __properties: ClassVar[List[str]] = ["id", "url", "token", "alertingIntegrationType", "alertingProfileName"]

...
class OpenshiftListDto(BaseModel):
    """
    OpenshiftListDto
    """ # noqa: E501
    id: Optional[StrictInt]
    name: Optional[StrictStr]
    base_domain: Optional[StrictStr] = Field(alias="baseDomain")
    storage_class: Optional[StrictStr] = Field(alias="storageClass")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "baseDomain", "storageClass", "organizationId", "organizationName", "projects", "projectCount", "isLocked", "createdBy", "lastModified", "lastModifiedBy", "isDefault", "createdAt", "continentName"]

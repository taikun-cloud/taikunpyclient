...
class HelmStatus(BaseModel):
    ...
    HelmStatus
    """ # noqa: E501
    conditions: Optional[List[HelmCondition]] = None
    failures: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["conditions", "failures"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conditions": [HelmCondition.from_dict(_item) for _item in obj["conditions"]] if obj.get("conditions") is not None else None,

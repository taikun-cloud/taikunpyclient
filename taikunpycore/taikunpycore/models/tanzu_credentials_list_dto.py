...
class TanzuCredentialsListDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "projectCount", "isLocked", "name", "username", "url", "volumeType", "namespace", "port", "projects", "createdBy", "createdAt", "lastModified", "lastModifiedBy", "isDefault", "organizationId", "organizationName", "continentName"]

...
class AmazonCredentialsListDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "projectCount", "isLocked", "name", "region", "availabilityZones", "availabilityZonesCount", "projects", "createdBy", "lastModified", "lastModifiedBy", "isDefault", "organizationId", "organizationName", "createdAt", "continentName"]

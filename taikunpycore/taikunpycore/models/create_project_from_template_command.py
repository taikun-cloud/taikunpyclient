...
class CreateProjectFromTemplateCommand(BaseModel):
    """
    CreateProjectFromTemplateCommand
    """ # noqa: E501
    id: Optional[StrictInt] = None
    project_name: Optional[StrictStr] = Field(default=None, alias="projectName")
    can_commit: Optional[StrictBool] = Field(default=None, alias="canCommit")
    __properties: ClassVar[List[str]] = ["id", "projectName", "canCommit"]

...
class StandAloneProfileSecurityGroupForDetailsDto(BaseModel):
    """
    ...
    is_rdp_port_enabled: Optional[StrictBool] = Field(alias="isRdpPortEnabled")
    __properties: ClassVar[List[str]] = ["id", "name", "protocol", "portMinRange", "portMaxRange", "remoteIpPrefix", "isRdpPortEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isRdpPortEnabled": obj.get("isRdpPortEnabled")
        })
        return _obj

...
class OpenStackNetworkListQuery(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["openStackUser", "openStackPassword", "openStackUrl", "openStackProjectId", "openStackDomain", "openStackRegion", "applicationCredEnabled", "isAdmin"]

...
class UserDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "isMaintenanceModeEnabled", "trialDays"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": UserForListDto.from_dict(obj["data"]) if obj.get("data") is not None else None,

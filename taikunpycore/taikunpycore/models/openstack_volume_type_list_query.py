...
class OpenstackVolumeTypeListQuery(BaseModel):
    """
    ...
    openstack_project: Optional[StrictStr] = Field(default=None, alias="openstackProject")
    __properties: ClassVar[List[str]] = ["projectId", "openStackUser", "openStackPassword", "openStackUrl", "openStackDomain", "openStackRegion", "applicationCredEnabled", "isAdmin", "openstackProject"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if openstack_project (nullable) is None
        # and model_fields_set contains the field
        if self.openstack_project is None and "openstack_project" in self.model_fields_set:

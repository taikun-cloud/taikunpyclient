...
class CreateAlertDto(BaseModel):
    ...
    CreateAlertDto
    """ # noqa: E501
    alerts: Optional[List[KubernetesAlertCreateDto]] = None
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["alerts", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alerts": [KubernetesAlertCreateDto.from_dict(_item) for _item in obj["alerts"]] if obj.get("alerts") is not None else None,

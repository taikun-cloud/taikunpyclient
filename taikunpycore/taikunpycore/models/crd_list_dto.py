...
class CrdListDto(BaseModel):
    """
    CrdListDto
    """ # noqa: E501
    metadata_name: Optional[StrictStr] = Field(alias="metadataName")
    spec_name_kind: Optional[StrictStr] = Field(alias="specNameKind")
    list_kind: Optional[StrictStr] = Field(alias="listKind")
    group: Optional[StrictStr]
    labels: Optional[Any]
    age: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["metadataName", "specNameKind", "listKind", "group", "labels", "age"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "specNameKind": obj.get("specNameKind"),

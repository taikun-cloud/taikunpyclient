...
class UpdateOrganizationSubscriptionCommand(BaseModel):
    """
    UpdateOrganizationSubscriptionCommand
    """ # noqa: E501
    subscription_id: Optional[StrictInt] = Field(default=None, alias="subscriptionId")
    is_yearly: Optional[StrictBool] = Field(default=None, alias="isYearly")
    __properties: ClassVar[List[str]] = ["subscriptionId", "isYearly"]

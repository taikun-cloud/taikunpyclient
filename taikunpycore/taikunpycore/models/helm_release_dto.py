...
class HelmReleaseDto(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind"),
            "metadata": HelmReleaseMetaData.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "spec": HelmReleaseSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": HelmStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj

...
class OpenStackZoneListQuery(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["openStackUser", "openStackPassword", "openStackUrl", "openStackDomain", "openStackRegion", "applicationCredEnabled", "isAdmin", "openstackProject"]

...
class KubernetesCronJobDto(BaseModel):
    """
    KubernetesCronJobDto
    """ # noqa: E501
    metadata_name: Optional[StrictStr] = Field(alias="metadataName")
    last_schedule: Optional[StrictStr] = Field(alias="lastSchedule")
    suspend: Optional[StrictBool]
    schedule: Optional[StrictStr]
    namespace: Optional[StrictStr]
    age: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["metadataName", "lastSchedule", "suspend", "schedule", "namespace", "age"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastSchedule": obj.get("lastSchedule"),

...
class PvcDto(BaseModel):
    ...
    storage_class_name: Optional[StrictStr] = Field(alias="storageClassName")
    age: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["metadataName", "phase", "size", "namespace", "storageClassName", "age"]

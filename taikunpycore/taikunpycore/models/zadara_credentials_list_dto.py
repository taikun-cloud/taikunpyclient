...
class ZadaraCredentialsListDto(BaseModel):
    """
    ...
    zadara_api_url: Optional[StrictStr] = Field(alias="zadaraApiUrl")
    zadara_volume_type: Optional[StrictStr] = Field(alias="zadaraVolumeType")
    __properties: ClassVar[List[str]] = ["id", "projectCount", "isLocked", "name", "region", "availabilityZones", "availabilityZonesCount", "projects", "createdBy", "lastModified", "lastModifiedBy", "isDefault", "organizationId", "organizationName", "createdAt", "continentName", "zadaraApiUrl", "zadaraVolumeType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "zadaraApiUrl": obj.get("zadaraApiUrl"),

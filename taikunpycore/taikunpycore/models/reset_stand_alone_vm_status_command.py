...
class ResetStandAloneVmStatusCommand(BaseModel):
    """
    ResetStandAloneVmStatusCommand
    """ # noqa: E501
    project_id: Optional[StrictInt] = Field(default=None, alias="projectId")
    vm_ids: Optional[List[StrictInt]] = Field(default=None, alias="vmIds")
    status: Optional[StandAloneVmStatus] = None
    __properties: ClassVar[List[str]] = ["projectId", "vmIds", "status"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if vm_ids (nullable) is None
        # and model_fields_set contains the field
        if self.vm_ids is None and "vm_ids" in self.model_fields_set:
            _dict['vmIds'] = None

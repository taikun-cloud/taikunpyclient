...
class AllowedHostListDto(BaseModel):
    """
    AllowedHostListDto
    """ # noqa: E501
    ...
    mask_bits: Optional[StrictInt] = Field(alias="maskBits")
    ...
    __properties: ClassVar[List[str]] = ["id", "description", "ipAddress", "maskBits", "accessProfileId", "accessProfileName"]

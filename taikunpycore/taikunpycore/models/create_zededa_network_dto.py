...
class CreateZededaNetworkDto(BaseModel):
    """
    ...
    begin_allocation_range: Optional[StrictStr] = Field(default=None, alias="beginAllocationRange")
    end_allocation_range: Optional[StrictStr] = Field(default=None, alias="endAllocationRange")
    __properties: ClassVar[List[str]] = ["interface", "gateway", "ipAddress", "netMask", "vlanId", "beginAllocationRange", "endAllocationRange"]

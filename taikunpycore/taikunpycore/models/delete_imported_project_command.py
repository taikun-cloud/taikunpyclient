...
class DeleteImportedProjectCommand(BaseModel):
    """
    DeleteImportedProjectCommand
    """ # noqa: E501
    project_id: Optional[StrictInt] = Field(default=None, alias="projectId")
    is_force_delete: Optional[StrictBool] = Field(default=None, alias="isForceDelete")
    __properties: ClassVar[List[str]] = ["projectId", "isForceDelete"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isForceDelete": obj.get("isForceDelete")
        })
        return _obj

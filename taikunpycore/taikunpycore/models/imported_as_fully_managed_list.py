...
class ImportedAsFullyManagedList(BaseModel):
    """
    ImportedAsFullyManagedList
    """ # noqa: E501
    visibility: ImportedAsFullyManagedVisibility
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "visibility": ImportedAsFullyManagedVisibility.from_dict(obj["visibility"]) if obj.get("visibility") is not None else None,

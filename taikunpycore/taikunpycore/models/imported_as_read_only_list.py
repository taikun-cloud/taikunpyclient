...
class ImportedAsReadOnlyList(BaseModel):
    """
    ImportedAsReadOnlyList
    """ # noqa: E501
    visibility: ImportedAsReadOnlyVisibility
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "visibility": ImportedAsReadOnlyVisibility.from_dict(obj["visibility"]) if obj.get("visibility") is not None else None,

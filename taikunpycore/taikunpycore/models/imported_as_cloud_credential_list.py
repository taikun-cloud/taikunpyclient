...
class ImportedAsCloudCredentialList(BaseModel):
    """
    ImportedAsCloudCredentialList
    """ # noqa: E501
    visibility: ImportedAsCloudCredentialVisibility
    data: ImportedClusterDetailsDto
    __properties: ClassVar[List[str]] = ["visibility", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "visibility": ImportedAsCloudCredentialVisibility.from_dict(obj["visibility"]) if obj.get("visibility") is not None else None,
            "data": ImportedClusterDetailsDto.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj

...
class BackupCredentialsForOrganizationEntity(BaseModel):
    """
    BackupCredentialsForOrganizationEntity
    """ # noqa: E501
    backup_credential_id: Optional[StrictInt] = Field(default=None, alias="backupCredentialId")
    ...
    __properties: ClassVar[List[str]] = ["backupCredentialId", "name", "isDefault", "isInfra"]

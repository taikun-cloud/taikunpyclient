...
class Alert(BaseModel):
    ...
    Alert
    """ # noqa: E501
    labels: Optional[AlertLabels] = None
    annotations: Optional[Annotations] = None
    state: Optional[StrictStr] = None
    active_at: Optional[datetime] = Field(default=None, alias="activeAt")
    value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["labels", "annotations", "state", "activeAt", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "labels": AlertLabels.from_dict(obj["labels"]) if obj.get("labels") is not None else None,

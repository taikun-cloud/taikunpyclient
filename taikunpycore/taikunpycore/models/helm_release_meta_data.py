...
class HelmReleaseMetaData(BaseModel):
    """
    HelmReleaseMetaData
    """ # noqa: E501
    creation_timestamp: Optional[StrictStr] = Field(default=None, alias="creationTimestamp")
    name: Optional[StrictStr] = None
    namespace: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["creationTimestamp", "name", "namespace"]

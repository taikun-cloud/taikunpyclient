...
class PrometheusDashboardListDto(BaseModel):
    """
    PrometheusDashboardListDto
    """ # noqa: E501
    category_name: Optional[StrictStr] = Field(alias="categoryName")
    data: Optional[List[PrometheusDashboardDto]]
    __properties: ClassVar[List[str]] = ["categoryName", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [PrometheusDashboardDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj

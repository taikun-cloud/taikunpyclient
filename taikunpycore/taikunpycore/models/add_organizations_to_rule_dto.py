...
class AddOrganizationsToRuleDto(BaseModel):
    """
    AddOrganizationsToRuleDto
    """ # noqa: E501
    organization_id: Optional[StrictInt] = Field(default=None, alias="organizationId")
    rule_discount_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="ruleDiscountRate")
    __properties: ClassVar[List[str]] = ["organizationId", "ruleDiscountRate"]

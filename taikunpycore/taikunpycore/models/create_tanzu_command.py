...
class CreateTanzuCommand(BaseModel):
    """
    CreateTanzuCommand
    """ # noqa: E501
    ...
    tanzu_continent: Optional[StrictStr] = Field(default=None, alias="tanzuContinent")
    port: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["organizationId", "name", "username", "url", "password", "volumeType", "namespace", "tanzuContinent", "port"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if tanzu_continent (nullable) is None
        # and model_fields_set contains the field
        if self.tanzu_continent is None and "tanzu_continent" in self.model_fields_set:
            _dict['tanzuContinent'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tanzuContinent": obj.get("tanzuContinent"),
            "port": obj.get("port")
        })
        return _obj

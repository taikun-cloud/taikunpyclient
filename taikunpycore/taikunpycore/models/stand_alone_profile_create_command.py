...
class StandAloneProfileCreateCommand(BaseModel):
    """
    StandAloneProfileCreateCommand
    """ # noqa: E501
    name: Optional[StrictStr] = None
    public_key: Optional[StrictStr] = Field(default=None, alias="publicKey")
    security_groups: Optional[List[StandAloneProfileSecurityGroupDto]] = Field(default=None, alias="securityGroups")
    organization_id: Optional[StrictInt] = Field(default=None, alias="organizationId")
    __properties: ClassVar[List[str]] = ["name", "publicKey", "securityGroups", "organizationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "securityGroups": [StandAloneProfileSecurityGroupDto.from_dict(_item) for _item in obj["securityGroups"]] if obj.get("securityGroups") is not None else None,

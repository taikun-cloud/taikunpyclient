...
class AzureFlavorsWithPriceDto(BaseModel):
    """
    ...
    max_data_disk_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxDataDiskCount")
    __properties: ClassVar[List[str]] = ["name", "windowsPrice", "linuxPrice", "windowsSpotPrice", "linuxSpotPrice", "cpu", "ram", "description", "maxDataDiskCount"]

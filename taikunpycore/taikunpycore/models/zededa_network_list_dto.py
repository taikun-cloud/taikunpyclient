...
class ZededaNetworkListDto(BaseModel):
    """
    ...
    vlan_id: Optional[StrictInt] = Field(alias="vlanId")
    __properties: ClassVar[List[str]] = ["bridge", "gateway", "ipAddress", "netMask", "beginAllocationRange", "endAllocationRange", "isPrivate", "isVirtualLbNetwork", "vlanId"]

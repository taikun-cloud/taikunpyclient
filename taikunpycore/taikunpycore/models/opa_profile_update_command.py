...
class OpaProfileUpdateCommand(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "forbidNodePort", "forbidHttpIngress", "requireProbe", "uniqueIngresses", "uniqueServiceSelector", "isNodeNameForbiddenInVC", "isMasterTaintEnforced", "allowedRepo", "forbidSpecificTags", "ingressWhitelist", "whitelistMasterTaintNamespaces"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if forbid_node_port (nullable) is None
        # and model_fields_set contains the field
        if self.forbid_node_port is None and "forbid_node_port" in self.model_fields_set:
            _dict['forbidNodePort'] = None

        # set to None if forbid_http_ingress (nullable) is None
        # and model_fields_set contains the field
        if self.forbid_http_ingress is None and "forbid_http_ingress" in self.model_fields_set:
            _dict['forbidHttpIngress'] = None

        # set to None if require_probe (nullable) is None
        # and model_fields_set contains the field
        if self.require_probe is None and "require_probe" in self.model_fields_set:
            _dict['requireProbe'] = None

        # set to None if unique_ingresses (nullable) is None
        # and model_fields_set contains the field
        if self.unique_ingresses is None and "unique_ingresses" in self.model_fields_set:
            _dict['uniqueIngresses'] = None

        # set to None if unique_service_selector (nullable) is None
        # and model_fields_set contains the field
        if self.unique_service_selector is None and "unique_service_selector" in self.model_fields_set:
            _dict['uniqueServiceSelector'] = None

        # set to None if is_node_name_forbidden_in_vc (nullable) is None
        # and model_fields_set contains the field
        if self.is_node_name_forbidden_in_vc is None and "is_node_name_forbidden_in_vc" in self.model_fields_set:
            _dict['isNodeNameForbiddenInVC'] = None

        # set to None if is_master_taint_enforced (nullable) is None
        # and model_fields_set contains the field
        if self.is_master_taint_enforced is None and "is_master_taint_enforced" in self.model_fields_set:
            _dict['isMasterTaintEnforced'] = None

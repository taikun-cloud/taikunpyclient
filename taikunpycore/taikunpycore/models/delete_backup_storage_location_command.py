...
class DeleteBackupStorageLocationCommand(BaseModel):
    """
    DeleteBackupStorageLocationCommand
    """ # noqa: E501
    project_id: Optional[StrictInt] = Field(default=None, alias="projectId")
    storage_location: Optional[StrictStr] = Field(default=None, alias="storageLocation")
    __properties: ClassVar[List[str]] = ["projectId", "storageLocation"]

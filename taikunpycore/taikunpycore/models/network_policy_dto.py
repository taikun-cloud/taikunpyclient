...
class NetworkPolicyDto(BaseModel):
    """
    NetworkPolicyDto
    """ # noqa: E501
    metadata_name: Optional[StrictStr] = Field(alias="metadataName")
    pod_selector: Dict[str, StrictStr] = Field(alias="podSelector")
    namespace: Optional[StrictStr]
    age: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["metadataName", "podSelector", "namespace", "age"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "podSelector": obj.get("podSelector"),

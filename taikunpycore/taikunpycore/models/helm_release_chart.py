...
class HelmReleaseChart(BaseModel):
    """
    HelmReleaseChart
    """ # noqa: E501
    spec: Optional[HelmReleaseChartSpec] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "spec": HelmReleaseChartSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
        return _obj

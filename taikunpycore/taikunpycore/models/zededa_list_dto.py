...
class ZededaListDto(BaseModel):
    ...
    edge_nodes: List[CommonDropdownDto] = Field(alias="edgeNodes")
    api_token: Optional[StrictStr] = Field(alias="apiToken")
    api_url: Optional[StrictStr] = Field(alias="apiUrl")
    project: Optional[StrictStr]
    project_id: Optional[StrictStr] = Field(alias="projectId")
    zededa_networks: List[ZededaNetworkListDto] = Field(alias="zededaNetworks")
    __properties: ClassVar[List[str]] = ["id", "projectCount", "isLocked", "name", "projects", "createdBy", "createdAt", "lastModified", "lastModifiedBy", "isDefault", "organizationId", "organizationName", "continentName", "edgeNodes", "apiToken", "apiUrl", "project", "projectId", "zededaNetworks"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in edge_nodes (list)
        _items = []
        if self.edge_nodes:
            for _item_edge_nodes in self.edge_nodes:
                if _item_edge_nodes:
                    _items.append(_item_edge_nodes.to_dict())
            _dict['edgeNodes'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in zededa_networks (list)
        _items = []
        if self.zededa_networks:
            for _item_zededa_networks in self.zededa_networks:
                if _item_zededa_networks:
                    _items.append(_item_zededa_networks.to_dict())
            _dict['zededaNetworks'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "edgeNodes": [CommonDropdownDto.from_dict(_item) for _item in obj["edgeNodes"]] if obj.get("edgeNodes") is not None else None,
            "apiToken": obj.get("apiToken"),
            "apiUrl": obj.get("apiUrl"),
            "project": obj.get("project"),
            "projectId": obj.get("projectId"),
            "zededaNetworks": [ZededaNetworkListDto.from_dict(_item) for _item in obj["zededaNetworks"]] if obj.get("zededaNetworks") is not None else None
        })
        return _obj

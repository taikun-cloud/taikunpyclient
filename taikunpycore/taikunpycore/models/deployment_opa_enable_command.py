...
class DeploymentOpaEnableCommand(BaseModel):
    """
    DeploymentOpaEnableCommand
    """ # noqa: E501
    project_id: Optional[StrictInt] = Field(default=None, alias="projectId")
    opa_credential_id: Optional[StrictInt] = Field(default=None, alias="opaCredentialId")
    __properties: ClassVar[List[str]] = ["projectId", "opaCredentialId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "opaCredentialId": obj.get("opaCredentialId")
        })
        return _obj

...
class StandAloneProfileForDetailsDto(BaseModel):
    """
    ...
    security_groups: Optional[List[StandAloneProfileSecurityGroupForDetailsDto]] = Field(alias="securityGroups")
    __properties: ClassVar[List[str]] = ["id", "name", "publicKey", "securityGroups"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "securityGroups": [StandAloneProfileSecurityGroupForDetailsDto.from_dict(_item) for _item in obj["securityGroups"]] if obj.get("securityGroups") is not None else None
        })
        return _obj

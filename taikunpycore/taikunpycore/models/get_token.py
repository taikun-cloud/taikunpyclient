...
class GetToken(BaseModel):
    ...
    refresh_token_expire_time: Optional[datetime] = Field(default=None, alias="refreshTokenExpireTime")
    temp_token: Optional[StrictStr] = Field(default=None, alias="tempToken")
    __properties: ClassVar[List[str]] = ["token", "refreshToken", "refreshTokenExpireTime", "tempToken"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if temp_token (nullable) is None
        # and model_fields_set contains the field
        if self.temp_token is None and "temp_token" in self.model_fields_set:
            _dict['tempToken'] = None

...
class StandAloneVmDiskDto(BaseModel):
    """
    StandAloneVmDiskDto
    """ # noqa: E501
    ...
    lun_id: Optional[StrictInt] = Field(default=None, alias="lunId")
    __properties: ClassVar[List[str]] = ["name", "size", "volumeType", "deviceName", "lunId"]

...
class OpenstackSubnetListQuery(BaseModel):
    """
    ...
    open_stack_project_id: Optional[StrictStr] = Field(default=None, alias="openStackProjectId")
    ...
    __properties: ClassVar[List[str]] = ["openStackUser", "openStackPassword", "openStackUrl", "openStackProject", "openStackProjectId", "openStackDomain", "openStackRegion", "applicationCredEnabled"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if open_stack_project_id (nullable) is None
        # and model_fields_set contains the field
        if self.open_stack_project_id is None and "open_stack_project_id" in self.model_fields_set:
            _dict['openStackProjectId'] = None

...
class CatalogAppDetailsDto(BaseModel):
    """
    ...
    app_repo_id: Optional[StrictInt] = Field(default=None, alias="appRepoId")
    ...
    project_apps: Optional[List[ProjectAppDto]] = Field(default=None, alias="projectApps")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "appRepoName", "appRepoOrganizationName", "appRepoId", "catalogName", "catalogId", "packageId", "version", "logoId", "projectApps", "description", "readme", "securityReport", "appVersion", "stars", "verifiedPublisher", "official", "hasJsonSchema"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in project_apps (list)
        _items = []
        if self.project_apps:
            for _item_project_apps in self.project_apps:
                if _item_project_apps:
                    _items.append(_item_project_apps.to_dict())
            _dict['projectApps'] = _items
        ...
        # set to None if project_apps (nullable) is None
        # and model_fields_set contains the field
        if self.project_apps is None and "project_apps" in self.model_fields_set:
            _dict['projectApps'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "projectApps": [ProjectAppDto.from_dict(_item) for _item in obj["projectApps"]] if obj.get("projectApps") is not None else None,

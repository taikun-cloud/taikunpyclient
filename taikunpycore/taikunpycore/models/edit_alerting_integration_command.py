...
class EditAlertingIntegrationCommand(BaseModel):
    """
    ...
    alerting_integration_type: Optional[AlertingIntegrationType] = Field(default=None, alias="alertingIntegrationType")
    alerting_profile_id: Optional[StrictInt] = Field(default=None, alias="alertingProfileId")
    __properties: ClassVar[List[str]] = ["id", "url", "token", "alertingIntegrationType", "alertingProfileId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "token": obj.get("token"),
            "alertingIntegrationType": obj.get("alertingIntegrationType"),

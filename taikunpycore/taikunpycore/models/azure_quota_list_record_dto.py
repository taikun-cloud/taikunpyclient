...
class AzureQuotaListRecordDto(BaseModel):
    """
    AzureQuotaListRecordDto
    """ # noqa: E501
    total_cores: Optional[StrictInt] = Field(default=None, alias="totalCores")
    current_usage: Optional[StrictInt] = Field(default=None, alias="currentUsage")
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["totalCores", "currentUsage", "name"]

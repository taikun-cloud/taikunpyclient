...
class AllFlavorsList(BaseModel):
    """
    AllFlavorsList
    """ # noqa: E501
    data: Optional[List[FlavorsListDto]]
    total_count: Optional[StrictInt] = Field(alias="totalCount")
    cloud_type: Optional[StrictStr] = Field(alias="cloudType")
    __properties: ClassVar[List[str]] = ["data", "totalCount", "cloudType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [FlavorsListDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

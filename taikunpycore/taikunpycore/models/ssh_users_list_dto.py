...
class SshUsersListDto(BaseModel):
    """
    SshUsersListDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "sshPublicKey", "accessProfileName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if access_profile_name (nullable) is None
        # and model_fields_set contains the field
        if self.access_profile_name is None and "access_profile_name" in self.model_fields_set:
            _dict['accessProfileName'] = None

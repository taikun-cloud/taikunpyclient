...
class ListAllBackupStorageLocations(BaseModel):
    """
    ListAllBackupStorageLocations
    """ # noqa: E501
    data: Optional[List[BackupStorageLocationDto]]
    total_count: Optional[StrictInt] = Field(alias="totalCount")
    projects: Optional[List[StrictInt]]
    __properties: ClassVar[List[str]] = ["data", "totalCount", "projects"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BackupStorageLocationDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

...
class FlavorsListDto(BaseModel):
    """
    FlavorsListDto
    """ # noqa: E501
    ...
    max_data_disk_count: Optional[Union[StrictFloat, StrictInt]] = Field(alias="maxDataDiskCount")
    __properties: ClassVar[List[str]] = ["ram", "cpu", "name", "description", "maxDataDiskCount"]

...
class KubernetesAlertDto(BaseModel):
    """
    KubernetesAlertDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "labels", "description", "title", "severity", "fingerprint", "status", "startsAt", "endAt", "isSolved", "projectId", "projectName", "isSilenced", "silenceReason", "lastModifiedBy", "isMonitoringEnabled"]

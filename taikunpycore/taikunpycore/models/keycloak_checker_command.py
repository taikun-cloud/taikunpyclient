...
class KeycloakCheckerCommand(BaseModel):
    """
    KeycloakCheckerCommand
    """ # noqa: E501
    name: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    realms_name: Optional[StrictStr] = Field(default=None, alias="realmsName")
    ...
    __properties: ClassVar[List[str]] = ["name", "url", "realmsName", "clientId", "clientSecret"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if realms_name (nullable) is None
        # and model_fields_set contains the field
        if self.realms_name is None and "realms_name" in self.model_fields_set:
            _dict['realmsName'] = None

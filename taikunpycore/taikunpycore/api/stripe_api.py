...
class StripeApi:
    ...
    def stripe_subscription_item_list(
    ...
    ) -> List[StripeSubscriptionItemDto]:
        ...
        _param = self._stripe_subscription_item_list_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[StripeSubscriptionItemDto]",
            '400': "ProblemDetails",
            '401': "ProblemDetails",
            '403': "ProblemDetails",
            '404': "ProblemDetails",
    ...
    @validate_call
    def stripe_subscription_item_list_with_http_info(
        self,
        subscription_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[StripeSubscriptionItemDto]]:
        """Get subscription item list
    ...
    @validate_call
    def stripe_subscription_item_list_without_preload_content(
        self,
        subscription_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _stripe_subscription_item_list_serialize(
        self,
        subscription_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/stripe/{subscriptionId}',
